...
class IPdecoder2(nn.Module):
    def __init__(self):
        ...
        self.up = nn.ConvTranspose2d(32, 16, 4, 2, 1, bias=True)
...
class IPdecoder1(nn.Module):
    def __init__(self):
        ...
        self.up = nn.ConvTranspose2d(16, 3, 4, 2, 1, bias=True)
    def forward(self, warped_f0, warped_f1, f_ip_up_0):
        inp = torch.cat([warped_f0, warped_f1, f_ip_up_0], 1)
        IP_out = self.convblock(inp)
        IP_out_up = self.up(IP_out)
...
class Decoder4(nn.Module):
    def __init__(self):
        ...
        self.convblock = nn.Sequential(
            convrelu(192, 108), 
            ResBlock(108, 24), 
            nn.ConvTranspose2d(108, 52, 4, 2, 1, bias=True)
        )
...
class Decoder3(nn.Module):
    def __init__(self):
        ...
        self.convblock = nn.Sequential(
            convrelu(244, 108), 
            ResBlock(108, 24), 
            nn.ConvTranspose2d(108, 36, 4, 2, 1, bias=True)
        )
...
class Decoder2(nn.Module):
    def __init__(self):
        ...
        self.convblock = nn.Sequential(
            convrelu(164, 96), 
            ResBlock(96, 24), 
            nn.ConvTranspose2d(96, 20, 4, 2, 1, bias=True)
        )
...
class Decoder1(nn.Module):
    def __init__(self):
        ...
        self.convblock = nn.Sequential(
            convrelu(84, 64), 
            ResBlock(64, 24), 
            nn.ConvTranspose2d(64, 7, 4, 2, 1, bias=True)
        )
...
class MSANet(nn.Module):
    def __init__(self, local_rank=-1, lr=1e-4):
        ...
        self.fusion_net = Fusion_Net(27, 5, 64)
